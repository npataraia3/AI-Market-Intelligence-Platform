...
- Streamlit and Plotly dashboard with Excel export of analysis and forecasts
...
```text
app/          FastAPI backend, storage, data collection, monitoring, assistant
